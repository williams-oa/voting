...
const contract_id = {
  ...
  txId: "d66f6c1be1007ad344e3b7bc2c7345522d6cac619209dd0b6ac9cf1c987eff7b",
  /** The output index */
  outputIndex: 0,
};
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h2>Who is the better player?</h2>
      </header>
      <TableContainer
        component={Paper}
        variant="outlined"
      ...
      >
        <Table>
          <TableHead>
            <TableRow>
              <TableCell align="center">Ronaldo</TableCell>
              <TableCell align="center">Messi</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <TableRow>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"Ronaldo"}
                    src={`${process.env.PUBLIC_URL}/${"Ronaldo"}.jfif`}
                  />
                </Box>
              </TableCell>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"Messi"}
                    src={`${process.env.PUBLIC_URL}/${"Messi"}.jfif`}
                  />
                </Box>
              </TableCell>
            </TableRow>
